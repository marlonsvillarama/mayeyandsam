...
export const createBookingData = () => {
    return {
        get name () { return bookingData.name || 'Marlon Villarama' },
        get email () { return bookingData.email || 'marlonsvillarama@gmail.com' },
        get checkIn () { return bookingData.checkIn || '2026-12-26' },
        get checkOut () { return bookingData.checkOut || '2026-12-28' },
        get roomType () { return bookingData.roomType || 9 },
        get roomCount () { return bookingData.roomCount || 1 },
        get guestCount () { return bookingData.guestCount || 6 },
        get requests () { return bookingData.requests || 'Allergic to dust; non-smoking please' },
        get withTransfer () { return bookingData.withTransfer },
        get transferCount () { return bookingData.transferCount || 2 },
        ...
        set roomType (value) { bookingData.roomType = value },
